...
func (this *ScaleHerdModel) Test() string {
	return "k8s test"
}
...
func (this *ScaleHerdModel) PostData() (format.HerdGetScale) {
...
func (this *ScaleHerdModel) GetData(service interface{}) () {
...
func (this *ScaleHerdModel) getPagInfo_data() []byte {
