...
// curl -H "Content-Type: application/json" -X GET  http://192.168.12.8:8080/api/v1/namespaces/default/replicationcontrollers
func (this *ClusterModel) GetClusterList() (format.ReplicationControllerList) {
...
func (this *ClusterModel) getPagInfo_data() []byte {
